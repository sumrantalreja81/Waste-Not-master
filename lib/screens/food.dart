    ...
    return Scaffold(
      ...
      body: Container(
        ...
        child: Wrap(
          ...
          children: [
            ImageDisplay(height: height, width: width, link:"https://images.unsplash.com/photo-1546069901-ba9599a7e63c?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=880&q=80" ),
            NameContainer(
              width: width,
              height: height,
              foodName: foodName,
